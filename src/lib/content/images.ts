...
export const instagramPosts: readonly InstagramPost[] = [
  {
    imageKey: 'flatWhite',
    caption: 'Thirty seconds of someone’s whole morning.',
    permalink: 'https://www.instagram.com/regulars.dxb',
    likes: 842,
  },
  {
    imageKey: 'kunafaToast',
    caption: 'Kunafa french toast. Weekends only until we find more hands.',
    permalink: 'https://www.instagram.com/regulars.dxb',
    likes: 1291,
  },
  {
    imageKey: 'pourOver',
    caption: 'Guji Uraga on filter this fortnight. Blueberry, jasmine, no notes.',
    permalink: 'https://www.instagram.com/regulars.dxb',
    likes: 604,
  },
  {
    imageKey: 'spaceMorning',
    caption: '7am. The best hour in the building.',
    permalink: 'https://www.instagram.com/regulars.dxb',
    likes: 977,
  },
  {
    imageKey: 'croissant',
    caption: 'Out by 10:30 again. Sorry. Set an alarm.',
    permalink: 'https://www.instagram.com/regulars.dxb',
    likes: 1544,
  },
  {
    imageKey: 'brunchTable',
    caption: 'Table six on a Saturday is the whole point of this.',
    permalink: 'https://www.instagram.com/regulars.dxb',
    likes: 731,
  },
  {
    imageKey: 'beansHouse',
    caption: 'Roast day. Tuesdays and Fridays, always.',
    permalink: 'https://www.instagram.com/regulars.dxb',
    likes: 488,
  },
  {
    imageKey: 'espresso',
    caption: 'Alserkal light doing the work for us.',
    permalink: 'https://www.instagram.com/regulars.dxb',
    likes: 1103,
  },
  {
    imageKey: 'karak',
    caption: 'Karak at cafeteria prices. On purpose. Forever.',
    permalink: 'https://www.instagram.com/regulars.dxb',
    likes: 2260,
  },
];
