...
export async function generateMetadata({
  ...
  if (!post) return buildMetadata({ title: 'Not found', description: '', path: '/ar/immersive/journal' });

  return buildMetadata({
    title: post.titleAr,
    description: post.excerptAr,
    path: `/ar/immersive/journal/${post.slug}`,
    locale: 'ar',
...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <TierJournalPost tier="immersive" locale="ar" slug={slug} />;
}
