...
export async function generateMetadata({
  ...
  if (!post) return buildMetadata({ title: 'Not found', description: '', path: '/immersive/journal' });

  return buildMetadata({
    title: post.title,
    description: post.excerpt,
    path: `/immersive/journal/${post.slug}`,
    locale: 'en',
...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <TierJournalPost tier="immersive" locale="en" slug={slug} />;
}
