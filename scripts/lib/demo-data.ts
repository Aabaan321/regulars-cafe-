...
export const subscribers: readonly {
  email: string;
  name: string | null;
  confirmed: boolean;
  daysAgo: number;
...
export const tables: readonly {
  ...
  {
    code: 'C1',
    label: 'Long table (north end)',
    labelAr: 'الطاولة الطويلة — الشمال',
    seatsMin: 1,
    seatsMax: 4,
    zone: 'main',
    shape: 'rect',
  ...
  {
    code: 'C2',
    label: 'Long table (south end)',
    labelAr: 'الطاولة الطويلة — الجنوب',
    seatsMin: 1,
    seatsMax: 4,
    zone: 'main',
    shape: 'rect',
  ...
  {
    code: 'Y3',
    label: 'Courtyard long',
    labelAr: 'الفناء — طاولة طويلة',
    seatsMin: 5,
    seatsMax: 8,
    zone: 'courtyard',
    shape: 'rect',
